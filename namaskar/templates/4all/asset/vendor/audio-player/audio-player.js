/*
modified version of: https://www.codehim.com/demo/javascript-audio-player-with-playlist/
*/

// Start simple player
function loadMp3Player(player) {
  ...
  function simp_startScript() {
    ...
    simp_audio = ap_simp.querySelector('.simp-audio-player');
  ...
  var simp_source = simp_playlist.querySelectorAll('li:not(.album)');
  ...
  var siiimp_config = ap_simp.dataset.config ? JSON.parse(ap_simp.dataset.config) : {
    shide_top: true, //show/hide album
    shide_btm: simp_playlist.length > 1, //show/hide playlist if num items>1
    auto_load: false //auto load audio file
  };

  var simp_config = {
    shide_top: simp_playlist.length === 1, //show/hide album
    shide_btm: simp_playlist.length !== 1, //show/hide playlist if num items>1
    auto_load: false //auto load audio file
  };
...
let players = document.querySelectorAll('.simple-audio-player')
players.forEach((player, key) => {
  loadMp3Player(player);
