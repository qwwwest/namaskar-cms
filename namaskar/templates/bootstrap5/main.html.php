...
<!-- <?= $this->theme."/"."jumbo.html" ?> -->
<?php foreach(N('folder.templates') as $key => $folder) : ?>
    <?php if(is_file("$folder".'/'."$this->theme/jumbo.html.php")): ?>
        <?php require "$folder".'/'."$this->theme/jumbo.html.php"; ?>
    <?php endif; ?>
<?php endforeach; ?>
<!-- end <?= $this->theme."/"."jumbo.html" ?> -->

<h2>Album</h2>

<!-- <?= $this->theme."/"."gallery.html" ?> -->
<?php foreach(N('folder.templates') as $key => $folder) : ?>
    <?php if(is_file("$folder".'/'."$this->theme/gallery.html.php")): ?>
        <?php require "$folder".'/'."$this->theme/gallery.html.php"; ?>
    <?php endif; ?>
<?php endforeach; ?>
<!-- end <?= $this->theme."/"."gallery.html" ?> -->


<!-- <?= $this->theme."/"."main.html" ?> -->
<?php foreach(N('folder.templates') as $key => $folder) : ?>
    <?php if(is_file("$folder".'/'."$this->theme/main.html.php")): ?>
        <?php require "$folder".'/'."$this->theme/main.html.php"; ?>
    <?php endif; ?>
<?php endforeach; ?>
<!-- end <?= $this->theme."/"."main.html" ?> -->


<!-- <?= $this->theme."/"."featurette.html" ?> -->
<?php foreach(N('folder.templates') as $key => $folder) : ?>
    <?php if(is_file("$folder".'/'."$this->theme/featurette.html.php")): ?>
        <?php require "$folder".'/'."$this->theme/featurette.html.php"; ?>
    <?php endif; ?>
<?php endforeach; ?>
<!-- end <?= $this->theme."/"."featurette.html" ?> -->
