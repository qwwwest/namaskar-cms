...
class QwwwickRenderer
{
    ...
    public function __construct($templateFolders)
    {
        ...
        $this->blockbooster = new BlockBooster($this);
    ...
    public function renderPage($template)
    {
        ...
        $content = $this->blockbooster->reShape($content);
    ...
    public function includeTemplate($attributes, $content, $templateName, $selfRemoveOnEmpty)
    {
        static $rec = 0;
    ...
    public function isSetValue($attributes, $val): bool
    {
        foreach ($attributes as $key => $value) {
    ...
    public function getClassesAndId($attributes): string
    {
        ...
        $id = trim($this->id($attributes));
        $classes = trim($this->getCssClasses($attributes));
